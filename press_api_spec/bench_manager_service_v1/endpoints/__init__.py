...
from press_api_spec.bench_manager_service_v1.endpoints.app import apps
from press_api_spec.bench_manager_service_v1.endpoints.bench import *  # noqa: F401,F403
from press_api_spec.bench_manager_service_v1.endpoints.bench import bench
from press_api_spec.compute_service_v1.base import Endpoint, EndpointGroup

ALL_GROUPS: list[EndpointGroup] = [apps, bench]
