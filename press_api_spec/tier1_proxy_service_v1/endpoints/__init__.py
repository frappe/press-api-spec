...
from press_api_spec.tier1_proxy_service_v1.endpoints.cert import *  # noqa: F401,F403
from press_api_spec.tier1_proxy_service_v1.endpoints.cert import Tier1CertGroup
...
ALL_GROUPS: list[EndpointGroup] = [Tier1RouteGroup, Tier1CertGroup]
