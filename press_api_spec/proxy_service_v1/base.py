"""Framework-agnostic REST API endpoint specification primitives."""
...
@dataclass
class EndpointGroup:
    """A collection of endpoints sharing a URL prefix and tags."""
    ...
    def add(self, endpoint: Endpoint[BodyT, ResponseT]) -> Endpoint[BodyT, ResponseT]:
        ...
        if prefixed_path != endpoint.path or merged_tags != endpoint.tags:
            endpoint = Endpoint(
